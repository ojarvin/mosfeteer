...
export const PLACEMENT_LABELS = {
  ...
  adc: 'ADC', dac: 'DAC',
  dff: 'D flip-flop (CLK, RST)', dff_qb: 'D flip-flop (CLK, RST, Q, QB)',
  dff_clkb: 'D flip-flop (CLKB, RST)', dff_clkb_qb: 'D flip-flop (CLKB, RST, Q, QB)',
  ...
  latch: 'L latch (EN, RST)', latch_qb: 'L latch (EN, RST, Q, QB)',
  latch_enb: 'L latch (ENB, RST)', latch_enb_qb: 'L latch (ENB, RST, Q, QB)',
