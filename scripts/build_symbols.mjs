...
const rows = [
  ...
  },
  {
    ...
    items: [
      ...
      ['dff_clkb_qb', 'U25', 1440], ['dff_rst', 'U26', 1920],
      ['dff_rst_qb', 'U27', 2400], ['dff_clkb_rst', 'U28', 2880],
      ['dff_clkb_rst_qb', 'U29', 3360],
    ],
  },
  {
    label: 'Sequential',
    id: 'sequential_dff_rstb',
    annotate: false,
    y: 2800,
    items: [
      ['dff_rstb', 'U30', 0], ['dff_rstb_qb', 'U31', 480],
      ['dff_clkb_rstb', 'U32', 960], ['dff_clkb_rstb_qb', 'U33', 1440],
    ],
  },
  {
    label: 'Sequential',
    ...
    y: 3200,
    items: [
      ['latch', 'U34', 0], ['latch_qb', 'U35', 480], ['latch_enb', 'U36', 960],
      ['latch_enb_qb', 'U37', 1440], ['latch_rst', 'U38', 1920],
      ['latch_rst_qb', 'U39', 2400], ['latch_enb_rst', 'U40', 2880],
      ['latch_enb_rst_qb', 'U41', 3360],
    ],
  },
  {
    label: 'Sequential',
    id: 'sequential_latch_rstb',
    annotate: false,
    y: 3600,
    items: [
      ['latch_rstb', 'U42', 0], ['latch_rstb_qb', 'U43', 480],
      ['latch_enb_rstb', 'U44', 960], ['latch_enb_rstb_qb', 'U45', 1440],
    ],
  },
  {
    label: 'Blocks',
